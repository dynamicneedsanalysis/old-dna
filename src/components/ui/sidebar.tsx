...
function useSidebar() {
  // Check for valid sidebar context.
  ...
  (
    ...
    React.useEffect(() => {
      const handleKeyDown = (event: KeyboardEvent) => {
        // Defined shortcut key +
        //    Windows: Ctrl Or Windows
        //    Mac: Ctrl Or Command
        if (
      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar min-h-svh w-full md:flex",
              className
            )}
            ref={ref}
            {...props}
