...
import { generateRealBeneficiaryLifeExpectancyDistribution } from "@/lib/beneficiaries/utils";
import {
  ChartContainer,
  ChartLegend,
  ChartLegendContent,
...
// Takes: An array of AssetWithAssetBeneficiaries objects, an array of Beneficiaries, and a lifeExpectancy year.
export function RealBeneficiaryDistributionLifeExpectancy({
  assets,
  beneficiaries,
  lifeExpectancyYear,
}: {
  ...
  // Use passed Assets and life expectancy year to generate chart data.
  const chartData = useMemo(() => {
    const realBeneficiaries = generateRealBeneficiaryLifeExpectancyDistribution(
      assets,
      lifeExpectancyYear
    );
